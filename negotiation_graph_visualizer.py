...
graph.add_edge("accept_negotiation", "send_message")
...
print("--- Mermaid Code ---")
print(whatsapp_negotiation_graph.get_graph().draw_mermaid())

print("\n--- ASCII Visualization ---")
print(whatsapp_negotiation_graph.get_graph().draw_ascii())
