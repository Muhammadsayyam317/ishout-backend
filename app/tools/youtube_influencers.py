...
async def search_youtube_influencers(query: str, limit: int = 10, min_followers: int = None, max_followers: int = None, country: str = None) -> Dict[str, Any]:
    """
    ...
    result = await query_vector_store(query, "youtube", limit, min_followers, max_followers, country)
